...
class SmartTableProyecto extends Component {
    ...
    openCreate() {
        ...
        /*  this.context.router.push(`/administracion/proyecto/crear-cliente/${this.state.add_btn.path}`); */
    }
...
export default SmartTableProyecto;